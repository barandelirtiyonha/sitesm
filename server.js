...
const IDler = {
  ...
  botCallbackURL: "https://codeworkweb.glitch.me/callback",
  ...
  kodPaylaşamayacakRoller: ["746459940302094358", "BANLI ROL İD"],
  hazırAltyapılarRolü: "722069348902109256",
  hazırSistemlerRolü: "722069348902109256",
  elmasKodlarRolü: "722069348902109256",
  altınKodlarRolü: "722069344871383100",
  normalKodlarRolü: "722069348109385838"
};
...
app.post("/paylasim", (req, res) => {
  ...
  client.channels.cache.get(IDler.kodLogKanalı).send(
    ...
    .addField("Kod Sayfası", `[Tıkla!](http://www.codeworkweb.cf/${obj.kod_rank}/${obj.id})`));
